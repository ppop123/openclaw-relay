...
3. **配对并连接**
   ...
   终端会打印 Relay 地址、访问令牌和网关公钥。在 30 秒内打开 `client/index.html`，填入这三个值，点击连接。
...
3. **Pair and Connect**
   ...
   The terminal prints a relay URL, access token, and gateway public key. Within 30 seconds, open `client/index.html`, enter these three values, and click Connect.
